...
import { fluxoBonusJet } from "../../../../utils/FluxoSAC";

// Estrutura do fluxo de atendimento

const FluxoJetBonus = () => {
  const [currentNode, setCurrentNode] = useState(fluxoBonusJet);
