...
import { fluxoBonusPin } from "../../../../utils/FluxoSAC";

// Estrutura do fluxo de atendimento

const FluxoPinBonus = () => {
  const [currentNode, setCurrentNode] = useState(fluxoBonusPin);
