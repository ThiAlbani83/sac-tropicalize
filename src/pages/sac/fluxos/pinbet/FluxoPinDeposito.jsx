...
import { fluxoDepositosPin } from "../../../../utils/FluxoSAC";

// Estrutura do fluxo de atendimento

const FluxoPinDeposito = () => {
  const [currentNode, setCurrentNode] = useState(fluxoDepositosPin);
  ...
  const handleClear = () => {
    setCurrentNode(fluxoDepositosPin);
...
export default FluxoPinDeposito;
